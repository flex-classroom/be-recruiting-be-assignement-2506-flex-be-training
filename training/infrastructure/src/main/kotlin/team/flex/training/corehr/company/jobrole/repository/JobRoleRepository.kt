...
package team.flex.training.corehr.company.jobrole.repository
...
interface JobRoleRepository {
    fun findByJobRoleIdentity(companyIdentity: CompanyIdentity, jobRoleIdentity: JobRoleIdentity): JobRoleModel?
